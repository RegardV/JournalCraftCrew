#!/usr/bin/env python3
"""
OpenAI-Powered Journal Platform Server
Phase 2 Implementation: BYO OpenAI API Key System
Real AI journal generation with cost tracking
"""
...
app = FastAPI(
    title="Journal Craft Crew - OpenAI Edition",
    description="AI-powered journal platform with BYO OpenAI API key system",
    version="2.0.0"
)
...
async def web_interface():
    """Main web interface with OpenAI integration"""
...
<head>
    ...
    <title>Journal Craft Crew - OpenAI Edition</title>
    <style>
        :root {
        ...
        <div class="container">
            ...
            <section class="auth-section" id="authSection">
                <div class="hero">
                    ...
                    <p>Create beautiful, AI-powered journals with your own OpenAI API key</p>
                        ...
                        <form id="registerForm">
                            ...
                            <div class="api-key-section">
                                ...
                                <input type="password" id="regApiKey" class="api-key-input"
                                       placeholder="sk-..." help="You can add this later in settings">
                                <small>Bring your own OpenAI API key for real AI generation</small>
                            </div>
